# This script creates a histogram plot for Global Active Power
...
# Create png file, add histogram to it, close png file
png(filename="plot1.png")
hist(x=data$Global_active_power, col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)", ylab="Frequency")
dev.off()